...
**Last Updated:** August 21, 2026 · 0.67.9 landed (projections DNA + attach hand). Package stays `0.66.0` until exit.  
...
**Debt (live):** [TECH-DEBT.md](TECH-DEBT.md) — **SD-020** (face paid; require door landed; work-plane able paid; host start_ports paid; capability voice paid; schedule fire paid; vitality work_cycle paid; journal king paid; journal leftover paid; projections king paid) · **SD-021** · **SD-022** · residual **SD-019** · **SD-016** / **BI-*** / **SI-*** / **SU-***  
...
José opened 0.67 (2026-08-20). **0.67.9** landed: projections is DNA + attach hand; `composition.has` dies on that unit. Ready-only `require_business_admission` sites stay. Exit is José.
...
| **Later** | [SD-021](TECH-DEBT.md#sd-021) remaining composition kings (webhook / compensation / analytics) · [VISION-0.56](docs/vision/VISION-0.56.md) · [NAVIGATOR](docs/vision/VISION-NAVIGATOR.md) · [TUNNELS](docs/vision/VISION-TUNNELS.md) → [Grove](docs/vision/VISION-GROVE.md) |
| **Experimental** | Pre-1.0 · **no LTS** — [README](README.md) |

## 0.67 — Dependents require the organ (**open** · José 2026-08-20 · execute `0.67.9`)
...
| Seed | Home |
|------|------|
| Remaining `composition.has` kings | [SD-021](TECH-DEBT.md#sd-021) — webhook / compensation / analytics |
