...
**Last Updated:** August 21, 2026 · 0.67.11 landed (compensation DNA + attach hand). Package stays `0.66.0` until exit.  
...
**Debt (live):** [TECH-DEBT.md](TECH-DEBT.md) — **SD-020** (face paid; require door landed; work-plane able paid; host start_ports paid; capability voice paid; schedule fire paid; vitality work_cycle paid; journal king paid; journal leftover paid; projections king paid; projections leftover paid; compensation king paid) · **SD-021** · **SD-022** · residual **SD-019** · **SD-016** / **BI-*** / **SI-*** / **SU-***  
...
José opened 0.67 (2026-08-20). **0.67.11** landed: compensation is DNA + attach hand; `composition.has` dies on that unit. Dual-attach leftover. Ready-only `require_business_admission` sites stay. Exit is José.
...
## 0.67 — Dependents require the organ (**open** · José 2026-08-20 · execute `0.67.11`)
...
| **0.67.12+** | 📋 more composition kings if José includes them |
