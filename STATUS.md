...
**Last Updated:** August 21, 2026 · 0.67.17 landed (analytics leftover: one organ). Package stays `0.66.0` until exit.  
...
José opened 0.67 (2026-08-20). **0.67.17** landed: analytics leftover is one organ; host slot aliases it; `analytics_enabled` refines that object. Ready-only `require_business_admission` sites stay. Exit is José.
...
| **Later** | [SD-021](TECH-DEBT.md#sd-021) bare outbox packaging · [VISION-0.56](docs/vision/VISION-0.56.md) · [NAVIGATOR](docs/vision/VISION-NAVIGATOR.md) · [TUNNELS](docs/vision/VISION-TUNNELS.md) → [Grove](docs/vision/VISION-GROVE.md) |
| **Experimental** | Pre-1.0 · **no LTS** — [README](README.md) |

## 0.67 — Dependents require the organ (**open** · José 2026-08-20 · execute `0.67.17`)
...
| **0.67.17** | ✅ analytics leftover: one organ; host slot aliases it; `analytics_enabled` refines; not a loop |
| **0.67.18+** | 📋 more composition if José includes it |
| **exit** | ADR-036 Accepted · stamp `0.67.0` · José |

**Floor:** sibling require + one drain-shaped proof (**0.67.1**). **Not this theme:** engine-as-walker · definition `requires`.

## Later seeds (not this season)

| Seed | Home |
|------|------|
| Bare outbox packaging | [SD-021](TECH-DEBT.md#sd-021) |
