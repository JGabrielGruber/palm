...
**Last Updated:** July 30, 2026 · **Slice:** **0.58.5** wait/inspect  
...
| **Next code** | **0.58.6** Assist + MCP dogfood bind. |
| **Done** | **0.58.0–0.58.5** through wait/inspect journey view |
...
## 0.58 — Session plane (**open** · through `0.58.5`)
