...
**Last Updated:** July 30, 2026 · **Slice:** **0.58.16** done · **next 0.58.17** kit door + dogfood  
...
| **Next code** | **0.58.17** kit door + surface dogfood → then **18–20** + **exit** ([VISION-0.58 §6.2](docs/VISION-0.58.md)) |
...
| **0.58.17** | 📋 next | **Single kit door** + CLI/MCP/WS dogfood on BoundSurface (no product plane dual-path) |
