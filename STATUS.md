...
**Last Updated:** August 20, 2026 · 0.67.5 landed (schedule fire on drain able). Package stays `0.66.0` until exit.  
...
**Debt (live):** [TECH-DEBT.md](TECH-DEBT.md) — **SD-020** (face paid; require door landed; work-plane able paid; host start_ports paid; capability voice paid; schedule fire paid) · **SD-021** · **SD-022** · residual **SD-019** · **SD-016** / **BI-*** / **SI-*** / **SU-***  
...
José opened 0.67 (2026-08-20). **0.67.5** landed: `tick_schedules` / host `tick_work` use drain able. Ready-only `require_business_admission` sites stay. Exit is José.
...
| **Later** | [SD-021](TECH-DEBT.md#sd-021) composition kings · [VISION-0.56](docs/vision/VISION-0.56.md) · [NAVIGATOR](docs/vision/VISION-NAVIGATOR.md) · [TUNNELS](docs/vision/VISION-TUNNELS.md) → [Grove](docs/vision/VISION-GROVE.md) |
| **Experimental** | Pre-1.0 · **no LTS** — [README](README.md) |

## 0.67 — Dependents require the organ (**open** · José 2026-08-20 · execute `0.67.5`)
...
| **0.67.6+** | 📋 leftover façades if José includes them |
| **exit** | ADR-036 Accepted · stamp `0.67.0` · José |

**Floor:** sibling require + one drain-shaped proof (**0.67.1**). **Not this theme:** SD-021 · journal · engine-as-walker · definition `requires`.

## Later seeds (not this season)

| Seed | Home |
|------|------|
| Remaining `composition.has` kings | [SD-021](TECH-DEBT.md#sd-021) — after face dependents |
