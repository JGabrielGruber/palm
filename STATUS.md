...
**0.64 is `work_drain` as the first real capability.** Walker + seats + no freelance wire + refuse reads DNA. Next: stop composition/flag listing the name. José exits when the organ is copyable. No patch queue.
