...
**Last Updated:** August 20, 2026 · 0.67.1 landed (`require_capability`). Package stays `0.66.0` until exit.  
...
**Debt (live):** [TECH-DEBT.md](TECH-DEBT.md) — **SD-020** (face paid; require door landed; able/façades remain) · **SD-021** · **SD-022** · residual **SD-019** · **SD-016** / **BI-*** / **SI-*** / **SU-***  
...
José opened 0.67 (2026-08-20). **0.67.1** landed: sibling `require_capability` + `CapabilityRefusedError` + drain-shaped proof. Next execute is **0.67.2+** (`able` / façades). Do not retune every ready-only site.
...
## 0.67 — Dependents require the organ (**open** · José 2026-08-20 · execute `0.67.1`)
