...
**Last Updated:** August 24, 2026 · 0.68.8 drops the empty `palm.common.runtimes` parking lot. Package stays `0.67.0` until 0.68 exit.  
...
José closed 0.67 (2026-08-21) and opened 0.68 as costume compost. **0.68.8** drops the empty `palm.common.runtimes` parking lot. Further units when José names them.
...
| **Later** | [SD-021](TECH-DEBT.md#sd-021) duals named in 0.68 · [VISION-0.56](docs/vision/VISION-0.56.md) · [NAVIGATOR](docs/vision/VISION-NAVIGATOR.md) · [TUNNELS](docs/vision/VISION-TUNNELS.md) → [Grove](docs/vision/VISION-GROVE.md) |
...
| **0.68.9+** | 📋 compost units José includes |
| **exit** | stamp `0.68.0` · José |

**Named remaining:** none until José includes more. `enable_state_snapshot` stays read packaging. Pattern/Provider `ready()` stays.
