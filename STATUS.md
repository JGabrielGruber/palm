...
**Last Updated:** August 20, 2026 · 0.67.7 landed (journal DNA + attach hand). Package stays `0.66.0` until exit.  
...
**Debt (live):** [TECH-DEBT.md](TECH-DEBT.md) — **SD-020** (face paid; require door landed; work-plane able paid; host start_ports paid; capability voice paid; schedule fire paid; vitality work_cycle paid; journal king paid) · **SD-021** · **SD-022** · residual **SD-019** · **SD-016** / **BI-*** / **SI-*** / **SU-***  
...
José opened 0.67 (2026-08-20). **0.67.7** landed: journal is DNA list + attach hand; `composition.has` dies on that unit. Ready-only `require_business_admission` sites stay. Exit is José.
...
## 0.67 — Dependents require the organ (**open** · José 2026-08-20 · execute `0.67.7`)
