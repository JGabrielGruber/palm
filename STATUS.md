...
**Open debt (→ 0.40):** ~~0.40.1–0.40.5 train complete~~ · durable dashboards (0.41) · event stream (0.42) — see [VISION-0.40](docs/VISION-0.40.md).
...
| Train | Focus | Status |
|-------|--------|--------|
| 0.40 | Close 0.37–0.38 debt; trigger dogfood; optional continuous drain; remote system analytics | ✅ 0.40.1–0.40.5 |
