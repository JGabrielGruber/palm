...
**Last Updated:** August 24, 2026 · 0.68.5 drops empty `LocalRunnerApp.ready()`. Package stays `0.67.0` until 0.68 exit.  
...
José closed 0.67 (2026-08-21) and opened 0.68 as costume compost. **0.68.5** drops the empty local runner `ready()` override. Further units when José names them.
...
**Named remaining:** none until José includes more. `enable_state_snapshot` stays read packaging.
