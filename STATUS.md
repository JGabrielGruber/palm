...
**Last Updated:** August 20, 2026 · 0.67.2 landed (work-plane `able` is drain). Package stays `0.66.0` until exit.  
...
**Debt (live):** [TECH-DEBT.md](TECH-DEBT.md) — **SD-020** (face paid; require door landed; work-plane able paid; host start_ports remain) · **SD-021** · **SD-022** · residual **SD-019** · **SD-016** / **BI-*** / **SI-*** / **SU-***  
...
José opened 0.67 (2026-08-20). **0.67.2** landed: work-plane `able` closes over `work_drain`; wait stays ready. Next: host `start_ports.able` only if José includes it. Do not retune every ready-only site.
...
## 0.67 — Dependents require the organ (**open** · José 2026-08-20 · execute `0.67.2`)
...
| **0.67.3+** | 📋 host `start_ports.able` if José includes it |
