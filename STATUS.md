...
**Last Updated:** August 4, 2026 · **Theme open:** **0.61.0** ✅ · **0.61.1** walk · **0.61.2** projection · **0.61.3** emission_window (stamps later)  
...
| **Next** | **0.61.4+** Inspect rename · growth (stamps when José exits) · host dogfood walk live |
