...
**Last Updated:** August 20, 2026 · 0.67.8 landed (journal leftover: one organ). Package stays `0.66.0` until exit.  
...
**Debt (live):** [TECH-DEBT.md](TECH-DEBT.md) — **SD-020** (face paid; require door landed; work-plane able paid; host start_ports paid; capability voice paid; schedule fire paid; vitality work_cycle paid; journal king paid; journal leftover paid) · **SD-021** · **SD-022** · residual **SD-019** · **SD-016** / **BI-*** / **SI-*** / **SU-***  
...
José opened 0.67 (2026-08-20). **0.67.8** landed: journal leftover is one attach on the runtime bus; host slot aliases that object; not a supervisor loop. Ready-only `require_business_admission` sites stay. Exit is José.
...
| **Later** | [SD-021](TECH-DEBT.md#sd-021) remaining composition kings · [VISION-0.56](docs/vision/VISION-0.56.md) · [NAVIGATOR](docs/vision/VISION-NAVIGATOR.md) · [TUNNELS](docs/vision/VISION-TUNNELS.md) → [Grove](docs/vision/VISION-GROVE.md) |
| **Experimental** | Pre-1.0 · **no LTS** — [README](README.md) |

## 0.67 — Dependents require the organ (**open** · José 2026-08-20 · execute `0.67.8`)
...
| **0.67.9+** | 📋 more composition kings if José includes them |
...
| Seed | Home |
|------|------|
| Remaining `composition.has` kings | [SD-021](TECH-DEBT.md#sd-021) — projections / webhook / compensation / analytics |
