...
**Current release:** `0.54.10` — **Debt paydown:** T3 import-cycle cleanup (upward edges 35→3, PD-012) + T2 `ApplicationHost` decomposition (1164→629 LOC, PD-013) · [CHANGELOG.md](CHANGELOG.md) · [ARCHITECTURE.md](ARCHITECTURE.md) · [docs/MCP.md](docs/MCP.md)
