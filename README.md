...
**Current release:** `0.58.20` — **Palm System** closed (`palm.system` · `palm.kits` · ExecutionPort) · [PALM.md](docs/PALM.md) · [CHANGELOG.md](CHANGELOG.md) · [ARCHITECTURE.md](ARCHITECTURE.md) · [docs/MCP.md](docs/MCP.md)
