...
| **0.54** | **Library Pipeline** — Palm builds the canopy | 🟡 open (0.54.0) · [VISION-0.54](docs/VISION-0.54.md) · [ADR-023](docs/adr/023-library-pipeline.md) | Pipeline definition on neonroot resources; horizon: DB adapters via runners |
