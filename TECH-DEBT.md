...
**Progress:** **0.63.1–0.63.7** seats · gates · coherence · seed · refuse · eyes. **0.63.20–0.63.30** product start/continue + planes + assist/flow edge. **0.63.31** — execution façade oath (workloads/providers/processes) + shared inject; product stop residual named.
