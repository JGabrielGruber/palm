...
**Last updated:** July 2026 (0.54.0 — Library as storage-backed product + DocsService; [docs/VISION-0.54.md](docs/VISION-0.54.md) · [docs/adr/023-library-pipeline.md](docs/adr/023-library-pipeline.md))
