...
Guide for contributors working on Palm **0.54.10** (services are the API, `/v1/api/…` REST, per-domain MCP, `host.execution.flows`).
...
├── common/            # Shared libs + residual server transport; SD-012 shims
