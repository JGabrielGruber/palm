...
from palm.patterns.wizard.flow.collection.phases.step import build_collection_phase
from palm.patterns.wizard.flow.phases.commit import build_commit_phase
from palm.patterns.wizard.flow.phases.input import build_input_phase
