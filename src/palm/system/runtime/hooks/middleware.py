...
class DriveObservabilityHook(JobHookAdapter):
    ...
    schedulers. Pass to :meth:`~palm.system.runtime.base.BaseRuntime.start` via
...
class AuthMiddleware(JobHookAdapter):
    ...
    :class:`~palm.system.runtime.base.BaseRuntime`. Enable via ``auth_enforce=True``
    on :meth:`~palm.system.runtime.base.BaseRuntime.start`.
    """
