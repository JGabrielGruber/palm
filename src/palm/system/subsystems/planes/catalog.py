...
and not open-coded on :class:`~palm.system.subsystems.planes.hub.SystemPlanes`.

To add a plane: write ``planes/<name>/definition.py`` with a
:class:`~palm.system.subsystems.planes.definition.PlaneDefinition`, then register it
