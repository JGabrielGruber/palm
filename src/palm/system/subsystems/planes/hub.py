...
Collaborators come from :class:`~palm.system.interfaces.install.InstallInterface`
via :class:`~palm.system.subsystems.planes.install_context.InstallContext` — not a bag dig.
"""
...
class SystemPlanes:
    """
    Planes subsystem — lifecycle home for reactive planes on one shell.
