...
class DefinitionExecutor:
    ...
    :class:`~palm.common.hooks.instance_persistence.InstancePersistenceHook` on the orchestration engine.
    """
    ...
    def prepare_process_plan(
        ...
        *,
        ...
        """Prepare a :class:`~palm.common.executions.process_submission.ProcessPlan` without submitting."""
