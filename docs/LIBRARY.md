...
| `docs/VISION-*.md` | Theme plans (optional later move to `docs/vision/`) — **0.62** multi-claimer **closed**: [VISION-0.62.md](VISION-0.62.md) · **0.61** vitality **closed**: [VISION-0.61.md](VISION-0.61.md) · seed essay [VISION-VITALITY](VISION-VITALITY.md) · **0.60** supervisor: [VISION-0.60.md](VISION-0.60.md) · queue: [VISION-SURFACE-DEFLATION](VISION-SURFACE-DEFLATION.md) · **0.58** session: [VISION-0.58.md](VISION-0.58.md) · **0.57** system: [VISION-0.57.md](VISION-0.57.md) |
