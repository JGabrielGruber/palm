...
- Journal is DNA + attach hand from 0.67.7. Projections is DNA + attach hand from 0.67.9. Remaining `composition.has` kings (webhook, compensation, analytics) stay [SD-021](../../TECH-DEBT.md#sd-021).
