...
- [x] Execute [VISION-0.58](../VISION-0.58.md) slices through **0.58.6** (seat + multi-attach + bind + job path + inspect + Assist dogfood).  
- [ ] Close **SD-008** when dogfood is enough + residual SI honest (WS/watches optional residual).  
