...
**Active plan:** none (0.65 closed). This file keeps **roles · ports · citizenship · modules**. Remainder: admission reshape. Outbox proof [VISION-0.65](closed/VISION-0.65.md) is closed.  
