...
| **Assembly remainder** | [VISION-0.66](VISION-0.66.md) (**closed**) | Step 3 paid. Step 4 dependents wait. |
...
**After this close:** Outbox is [VISION-0.65](VISION-0.65.md) (closed). Admission contract is [VISION-0.66](VISION-0.66.md) (closed). Step 4 dependents wait.
