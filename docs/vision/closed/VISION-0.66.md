...
**Exit:** José closed the theme (2026-08-20). The face publishes installed names. Step 4 dependents: [VISION-0.67](VISION-0.67.md) (**closed**). Remaining costume: [VISION-0.68](../VISION-0.68.md).
