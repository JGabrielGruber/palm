...
**Status:** 📗 **Theme open** (José 2026-08-20). Execute `0.67.15` landed. Package stamp stays `0.66.0` until exit.  
...
- Remaining `composition.has` kings (analytics) unless José includes them in 0.67.16+.  
