...
**Status:** 📗 **Theme open** (José 2026-08-20). Execute `0.67.12` landed. Package stamp stays `0.66.0` until exit.  
...
- Remaining `composition.has` kings (webhook, analytics) unless José includes them in 0.67.13+.  
