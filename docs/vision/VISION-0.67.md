...
**Status:** 📗 **Theme open** (José 2026-08-20). Execute `0.67.16` landed. Package stamp stays `0.66.0` until exit.  
...
- Analytics leftover (product `AnalyticsService` vs install organ) unless José includes it in 0.67.17+.  
