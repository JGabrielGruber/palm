...
| [VISION-0.66](vision/VISION-0.66.md) | **Open** — admission snapshot publishes installed capabilities |
...
**Assembly:** authority issues definition; pure engine reconciles; system applies effect intents; **admission** gates business that needs ground and publishes installed capabilities; clients use ports; composition root only wires. New definition → reassemble. Theme: [VISION-0.66](vision/VISION-0.66.md) (**open**) · law: [VISION-ASSEMBLY](vision/VISION-ASSEMBLY.md).
...
| Assembly (**0.63** closed) · first capability (**0.64** closed) · outbox proof (**0.65** closed) · admission on capabilities (**0.66** open) | [VISION-0.66](vision/VISION-0.66.md) · [ADR-035](adr/035-admission-sits-on-capabilities.md) Proposed · [VISION-0.65](vision/closed/VISION-0.65.md) · [ADR-034](adr/034-supervised-start-walks-registration.md) Accepted · seed [VISION-ASSEMBLY](vision/VISION-ASSEMBLY.md) · debt [SD-020](../TECH-DEBT.md#sd-020) / [SD-021](../TECH-DEBT.md#sd-021) |
...
| Assembly (organism truth) | **0.63 / 0.64 / 0.65 closed** · **0.66 open** — [VISION-0.66](vision/VISION-0.66.md) · seed [VISION-ASSEMBLY](vision/VISION-ASSEMBLY.md) |
