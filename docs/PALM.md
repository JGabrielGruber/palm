...
| **Session** (0.58) | Outside subject: bind, multi-instance walk, watch | System `planes.session` (bind law + job path + WS/cookie transport through 0.58.7); thin product later |
