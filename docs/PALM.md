...
| Assembly (**0.63** closed) · first capability (**0.64** closed) · outbox proof (**0.65** closed) · admission on capabilities (**0.66** closed) · dependents (**0.67** open · 0.67.16 analytics DNA + attach hand) | [VISION-0.67](vision/VISION-0.67.md) · [ADR-036](adr/036-require-capability.md) Proposed · seed [VISION-ASSEMBLY](vision/VISION-ASSEMBLY.md) · debt [SD-020](../TECH-DEBT.md#sd-020) / [SD-021](../TECH-DEBT.md#sd-021) |
