...
| [VISION-0.68](vision/VISION-0.68.md) | **Open** — the great cleansing (costume compost) |
...
| Assembly (**0.63** closed) · first capability (**0.64** closed) · outbox proof (**0.65** closed) · admission on capabilities (**0.66** closed) · dependents (**0.67** closed) · costume (**0.68** open) | [VISION-0.68](vision/VISION-0.68.md) · [ADR-036](adr/036-require-capability.md) Accepted · seed [VISION-ASSEMBLY](vision/VISION-ASSEMBLY.md) · debt [SD-021](../TECH-DEBT.md#sd-021) |
...
| Assembly (organism truth) | **0.63–0.67 closed** · **0.68 open** — [VISION-0.68](vision/VISION-0.68.md) · seed [VISION-ASSEMBLY](vision/VISION-ASSEMBLY.md) · costume compost |
