...
| Unused projection journal facade | **Gone (0.68.12).** No `drain_journal_projections` / `consume_for_projections` / doctor key `"projections"`. Living projections organ stays. `work_drain` stays. Do not wire this drain into rebuild. |
