...
| **Admission** | Published read gate: **may this act run?** Business-rule face. Business does not talk to engines / supervisor / structure seat. Should read **capability** (and ready / refuse). Not a second membership list. Sequence: [VISION-0.64](../vision/VISION-0.64.md). | Authn / authz; product dig into lower layers; organ catalog |
