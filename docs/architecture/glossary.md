...
| **Admission** | Published read gate: **may this act run?** Business-rule face. Business does not talk to engines / supervisor / structure seat. Reads **installed capabilities** (and ready / refuse). Not a second membership walker. Theme: [VISION-0.66](../vision/closed/VISION-0.66.md) (**closed**). | Authn / authz; product dig into lower layers; copy of `LOCAL_CAPABILITY_HANDS` |
