...
**First act next session:** José judges whether the organ is copyable. Journal as second organ only after that. Do not open [SD-020](../../../TECH-DEBT.md#sd-020) as a mid-theme dump — that ledger is dependents after the admission contract changes. Sequence: [VISION-0.64](../../vision/VISION-0.64.md).
